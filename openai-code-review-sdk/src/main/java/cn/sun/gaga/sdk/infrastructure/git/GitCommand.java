package cn.sun.gaga.sdk.infrastructure.git;

import cn.sun.gaga.sdk.types.utils.RandomStringUtils;
...
public class GitCommand {
    ...
    public String diff() throws IOException, InterruptedException {
        ...
        String latesrCommitHash = logReader.readLine();
        logReader.close();
        logProcess.waitFor();

        ProcessBuilder diffProcessBuilder = new ProcessBuilder("git", "diff", latesrCommitHash + "^", latesrCommitHash);
